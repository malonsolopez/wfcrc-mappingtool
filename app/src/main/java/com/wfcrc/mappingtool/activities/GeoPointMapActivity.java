...
import com.wfcrc.mappingtool.spatial.MapHelper;
import com.wfcrc.mappingtool.utilities.InfoLogger;
import com.wfcrc.mappingtool.widgets.GeoPointWidget;
...
//	private KmlLayer kk;
	...
	//private Button zoomPointButton;	###Osundwa edit to remove zoomPointButton###
...
//		mShowLocation.setClickable(false);
		...
		// Menu Layer Toggle
/*		Osundwa edit to comment out "Layers" button that is not needed in Map view
...
/*	Osundwa edits to remove ambiguous "Zoom to saved feature" from map zoom dialog
